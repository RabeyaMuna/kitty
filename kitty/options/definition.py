...
definition = Definition(
    'kitty',
    Action('map', 'parse_map', {'keyboard_modes': 'KeyboardModeMap', 'alias_map': 'AliasMap'}, ['KeyDefinition', 'kitty.fast_data_types.SingleKey']),
...
opt('mark2_background', '#f2dcd3', option_type='to_color', long_text='Color for marks of type 1 (beige)')
...
map('Insert selected word', 'insert_selected_word kitty_mod+p>w kitten hints --type word --program -', long_text='Select words and insert into terminal.')
